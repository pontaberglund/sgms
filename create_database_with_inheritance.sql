...
ALTER TABLE email_student ADD CONSTRAINT PK_email_student PRIMARY KEY (student_id,email);
...
ALTER TABLE email_instructor ADD CONSTRAINT PK_email_instructor PRIMARY KEY (instructor_id,email);
...
ALTER TABLE phone_number_student ADD CONSTRAINT FK_phone_number_student_0 FOREIGN KEY (student_id) REFERENCES student (student_id) ON DELETE CASCADE;
ALTER TABLE phone_number_instructor ADD CONSTRAINT FK_phone_number_instructor_0 FOREIGN KEY (instructor_id) REFERENCES instructor (instructor_id) ON DELETE CASCADE;
...
ALTER TABLE email_student ADD CONSTRAINT FK_email_student_0 FOREIGN KEY (student_id) REFERENCES student (student_id) ON DELETE CASCADE;
ALTER TABLE email_instructor ADD CONSTRAINT FK_email_instructor_0 FOREIGN KEY (instructor_id) REFERENCES instructor (instructor_id) ON DELETE CASCADE;
